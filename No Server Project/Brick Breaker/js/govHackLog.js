angular.module("myApp").directive('govHackLog', function(govService){


  return {
    templateUrl: "./views/hackerLog.html",
    restrict: "E",
    scope: {
      selector: "="
    },
    link: function(scope, element, attrs) {
      ...
      scope.goHack = function(selected){


        if (govService.selected) {
          govService.audio.play();
        ...
        var commandStart = ['Performing DNS Lookups for',
                        'Searching ' + govService.selected + " ",
                        'Analyzing ' + govService.selected + " ",
            ...
            commandParts = ['Data Structure',
                            'http://area51.gov?au&2',
                            'Top Secret Files',
                            'Chem Trail Reports',
                            'Daedalus Drone Program',
                            ' .... Searching ... ',
                            'http://illuminati.se/?23&88&far=2',
                            'http://OneTrueGod.ret45-33/?Nicolas_Cage',
                            "Edward Snowden Tracker",
                            "Jason Borne Tracker",
                            "Clones"],
            commandResponses = ['Authorizing ',
                         'Authorized...',
                         'Access Granted to ' + govService.selected,
                         'Breaching Firewall...',
                         ...
                         'No Security on Clintion\'s Server... ',
                         'Transfering Funds...'
                        ],
            isProcessing = false,
            processTime = 0,
        ...
        window.addEventListener('resize', function(){
              ...
              swal(
                'No Can Do',
                'You need to select a building first',
                'info'
              )
            }
          }
